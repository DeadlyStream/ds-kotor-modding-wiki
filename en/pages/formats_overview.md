...
- Area/module properties - static area info ([ARE](pages/formats_overview.md)), dynamic area info ([GIT](pages/formats_overview.md)), module info ([IFO](pages/formats_overview.md)), module pathing ([PTH](pages/formats_overview.md))
- Conversations/cutscenes - [DLG](pages/formats_overview.md)
- Universal templates - creatures ([UTC](pages/formats_overview.md)), doors ([UTD](pages/formats_overview.md)), encounters ([UTE](pages/formats_overview.md)), items ([UTI](pages/formats_overview.md)), merchants ([UTM](pages/formats_overview.md)), placeables ([UTP](pages/formats_overview.md)), sounds ([UTS](pages/formats_overview.md)), triggers ([UTT](pages/formats_overview.md)), waypoints ([UTW](pages/formats_overview.md))
- Factions - [FAC](pages/formats_overview.md)
- Journal - [JRL](pages/formats_overview.md)
- User interface - [GUI](pages/formats_overview.md)
- Legacy NWN formats - character (BIC/BTC), item (BTI)
...
Part of the random name generation system for creating player names during character creation. This format is poorly documented. Refer to [this forum post](https://smf.asmodei.net/index.php?PHPSESSID=tt17fgl8q5ipavedvvaanlp2fb&topic=22427.msg226098#msg226098) about the NWN implementation for further info.
